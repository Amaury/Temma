 ...
 *
 * Examples:
 * use \Trantor\Attributes\Methods\Head as TrHead;
 * #[TrHead]
...
class Head extends \Trantor\Web\Attribute {
	/**
	 * Constructor.
	 * @throws	\Trantor\Exceptions\Application	If a method other than HEAD is used.
