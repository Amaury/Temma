 ...
 * @link	https://www.trantor.org/en/documentation/datasource-zeromq
 */
 ...
 */
class ZeroMQ extends \Trantor\Base\Datasource {
	/** ZeroMQ socket. */
	 ...
	 * @return	\Trantor\Datasources\ZeroMQ	The created object.
	 * @throws	\Exception	If the DSN is not correct.
	 */
	static public function factory(string $dsn) : \Trantor\Datasources\ZeroMQ {
		TrLog::log('Trantor/Base', 'DEBUG', "\\Trantor\\Datasources\\oobject creation with DSN: '$dsn'.");
