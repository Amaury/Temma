 ...
 * @link	https://www.trantor.org/en/documentation/datasource-pushover
 */
 ...
 * <code>
 * // initialization
 * $push = \Trantor\Datasources\Pushover::factory('pushover://APP_TOKEN');
 * $push = \Trantor\Base\Datasource::factory('pushover://APP_TOKEN');
 *
 ...
 *     'priority'  => -1,
 *     'ttl'       =>  86400,
 *     'url'       => 'https://www.trantor.org/',
 *     'urlTitle'  => 'Trantor website',
 * ]);
 * </code>
 */
class Pushover extends \Trantor\Base\Datasource {
	/** URL of Pushover API. */
	 ...
	 * @return	\Trantor\Datasources\Pushover	The created instance.
	 * @throws	\Trantor\Exceptions\Database	If the DSN is invalid.
	 */
	static public function factory(string $dsn) : \Trantor\Datasources\Pushover {
		TrLog::log('Trantor/Base', 'DEBUG', "\\Trantor\\Datasources\\Pushover object creation with DSN: '$dsn'.");
		if (!str_starts_with($dsn, 'pushover://')) {
			TrLog::log('Trantor/Base', 'WARN', "Invalid Pushover DSN '$dsn'.");
			throw new \Trantor\Exceptions\Database("Invalid Pushover DSN '$dsn'.", \Trantor\Exceptions\Database::FUNDAMENTAL);
		}
