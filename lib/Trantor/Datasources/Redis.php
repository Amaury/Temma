 ...
 * @link	https://www.trantor.org/en/documentation/datasource-redis
 */
 ...
 *   <li><tt>redis://db.trantor.org:6379/2</tt></li>
 ...
 * try {
 *     // object creation
 *     $ndb = \Trantor\Datasources\Redis::factory('redis://localhost');
 *     $ndb = \Trantor\Base\Datasource::factory('redis://localhost');
 ...
 * </code>
 */
class Redis extends \Trantor\Base\Datasource {
	 ...
	 * @return	\Trantor\Datasources\Redis	The created object.
	 * @throws	\Exception	If the DSN is not correct.
	 */
	static public function factory(string $dsn) : \Trantor\Datasources\Redis {
		TrLog::log('Trantor/Base', 'DEBUG', "\\Trantor\\Datasources\\Redis object creation with DSN: '$dsn'.");
	...
	public function reconnect() {
		...
		try {
			...
			throw new \Trantor\Exceptions\Database('Redis database connexion error: ' . $e->getMessage(), \Trantor\Exceptions\Database::CONNECTION);
		}
	}
	/** Disconnection. */
