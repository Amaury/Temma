 ...
 */
class Dummy extends \Trantor\Base\Datasource {
	/**
	 * Factory.
	 * @param	string	$dsn	Parameter string (not used).
	 * @return	\Trantor\Datasources\Dummy	The created object.
	 */
	static public function factory(string $dsn) : \Trantor\Datasources\Dummy {
		TrLog::log('Trantor/Base', 'DEBUG', "Creation of a dummy datasource.");
		return (new self());
	}
	/**
	...
	public function __call(string $name, array $args) /* : null */ {
		TrLog::log('Trantor/Base', 'DEBUG', "Dummy datasource called on method '$name'.");
		return (null);
	}
	...
	public function get(string $key, mixed $defaultOrCallback=null, mixed $options=null) : mixed {
		TrLog::log('Trantor/Base', 'DEBUG', "Dummy datasource get() call.");
		if (is_callable($defaultOrCallback))
			return ($defaultOrCallback());
		return ($defaultOrCallback);
	}
