 ...
 */
class Client implements \Trantor\Base\Loadable, \ArrayAccess {
	 ...
	 * @return	\Trantor\Asynk\ClientExec	A new instance of the asynchronous method execution object.
	 */
	public function __get(string $name) {
		return (new \Trantor\Asynk\ClientExec($this->_loader, $name));
	}
	/* ********** ARRAY-LIKE ACCESS ********** */
	/**
	 * Fetch the name of the object that must be executed.
	...
	public function offsetGet(mixed $offset) : mixed {
		return (new \Trantor\Asynk\ClientExec($this->_loader, $offset));
	}
	/**
	 * Disabled.
