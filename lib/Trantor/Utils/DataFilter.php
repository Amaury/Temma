 ...
 * @link	https://www.trantor.org/en/documentation/helper-datafilter
 */

namespace Trantor\Utils;

use \Trantor\Exceptions\IO as TµIOException;
use \Trantor\Exceptions\Application as TµApplicationException;
...
class DataFilter {
	 ...
	 * @throws	\Trantor\Exceptions\IO		If the contract is not well formed (BAD_FORMAT).
	 * @throws	\Trantor\Exceptions\Application	If the input data doesn't respect the contract (API).
	 */
