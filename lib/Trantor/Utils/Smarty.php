 ...
 * @link	https://www.trantor.org/en/documentation/helper-smarty
 */
 ...
 */
class Smarty implements \Trantor\Base\Loadable {
	/** Configuration object. */
	protected \Trantor\Web\Config $_config;
	/** Smarty object. */
	private \Smarty $_smarty;

	/**
	 * Constructor.
	 * @param	\Trantor\Base\Loader	$loader	Dependency injection container.
	 */
	public function __construct(\Trantor\Base\Loader $loader) {
		...
		$compiledDir = $this->_config->tmpPath . '/' . \Trantor\Views\Smarty::COMPILED_DIR;
		...
		$cacheDir = $this->_config->tmpPath . '/' . \Trantor\Views\Smarty::CACHE_DIR;
		...
		$pluginPathList = [];
		$pluginPathList[] = $this->_config->appPath . '/' . \Trantor\Views\Smarty::PLUGINS_DIR;
	 ...
	 * @throws	\Trantor\Exceptions\IO	If the template doesnt exist.
	 */
