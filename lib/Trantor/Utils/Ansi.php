 ...
 * @copyright	© 2008-2024, Amaury Bouchard
 * @link	https://www.trantor.org/en/documentation/helper-ansi
 */
 ...
 * <code>
 * // write bold text
 * print(\Trantor\Utils\Ansi::bold('blah blah blah'));
 * // write "thin" text
 * print(\Trantor\Utils\Ansi::faint('blah blah blah'));
 * // write underlined text
 * print(\Trantor\Utils\Ansi::underline('blah blah blah'));
 * // write reversed video text
 * print(\Trantor\Utils\Ansi::negative('blah blah blah'));
 * // write text in red
 * // (available colors are: black, red, green, yellow, blue, magenta, cyan, white)
 * print(\Trantor\Utils\Ansi::color('red', 'blah blah blah'));
 * // write text in red over a blue background
 * print(\Trantor\Utils\Ansi::backColor('blue', 'red', 'blah blah blah'));
 * </code>
 *
...
class Ansi {
	 ...
	 * <a href="https://www.trantor.org">Trantor website</a>
	 *
	...
	static protected function _styleBlockContent(string $s, array $style=[]) : string {
		if (($style['display'] ?? null) != 'block')
			return ($s);
		[$screenWidth, $screenHeight] = TrTerm::getScreenSize();
