 ...
 * @link	https://www.trantor.org/en/documentation/helper-htmlcleaner
 */
 ...
 * $html = \Trantor\Utils\HTMLCleaner::text2html($text);
 *
 * // clean an HTML stream
 * $html = \Trantor\Utils\HTMLCleaner::clean($html);
 * </code>
 *
...
class HTMLCleaner {
	...
	static public function clean(string $html, ?bool $targetBlank=null, ?bool $nofollow=null, bool $removeNbsp=true) : string {
		...
		//$config->set("HTML.DefinitionID", "trantor-html-definition");
