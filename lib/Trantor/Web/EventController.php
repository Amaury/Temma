...
class EventController extends Controller {
	 ...
	 * @throws	\Trantor\Exceptions\FlowQuit	If the connection is closed.
	 */
	protected function _checkConnection() : void {
		if (connection_aborted())
			throw new \Trantor\Exceptions\FlowQuit();
	}
	/**
	 ...
	 * @throws	\Trantor\Exceptions\FlowQuit	If the client connection was aborted.
	 */
