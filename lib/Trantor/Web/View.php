...
abstract class View {
	 ...
	 * @param	\Trantor\Web\Config	$config		Configuration object.
	 * @param	\Trantor\Web\Response	$response	Response object.
	 */
	public function __construct(array|\ArrayAccess $dataSources, \Trantor\Web\Config $config, ?\Trantor\Web\Response $response=null) {
