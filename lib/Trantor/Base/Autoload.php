 ...
 * \Trantor\Base\Autoload::autoload('/path/to/lib');
 * \Trantor\Base\Autoload::autoload(['/path/to/lib1', '/path/to/lib2', '/path/to/lib3']);
 * // optional: Add namespaced include paths at init
 * \Trantor\Base\Autoload::autoload([
 *     '\Trantor\Base'      => '/path/to/trantor/base/directory',
 *     '\Acme\Log\Writer' => './acme-log-writer/lib/',
 * ]);
 *
 * // optional: Add include path after init (single path or list of paths)
 * \Trantor\Base\Autoload::addIncludePath('/path/to/lib');
 * \Trantor\Base\Autoload::addIncludePath(['/path/to/lib1', '/path/to/lib2', '/path/to/lib3']);
 * // optional: Add namespaced include paths
 * \Trantor\Base\Autoload::addIncludePath([
 *     '\Trantor\Base'      => '/path/to/trantor/base/directory',
 *     '\Acme\Log\Writer' => './acme-log-writer/lib/',
 * ]);
 * </code>
